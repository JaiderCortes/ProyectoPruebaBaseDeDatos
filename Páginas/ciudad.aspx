<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/maestra.Master" CodeBehind="ciudad.aspx.vb" Inherits="Proyecto_con_Base_de_Datos.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style10">
        <tr>
            <td class="auto-style12" colspan="4">Ciudad</td>
        </tr>
        <tr>
